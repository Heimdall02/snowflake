   ...
   <table>
      ...
      <tbody>
         <?php
            ...
            $select_women_products = mysqli_query($conn, "SELECT * FROM `women_products`");
            if(mysqli_num_rows($select_women_products) > 0){
               while($row = mysqli_fetch_assoc($select_women_products)){
         ?>
         ...
         <tr>
            ...
            <td>
               ...
               <a href="adminW.php?edit=<?php echo $row['id']; ?>"> <i class="fas fa-edit"></i> update </a>
            </td>
         </tr>
